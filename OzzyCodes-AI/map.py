...
def init():
    ...
    goal_x = 20 # the goal to reach is at the upper left of the map (the x-coordinate is 20 and 
                #not 0 because the car gets bad reward if it touches the wall)
...
# Creating the car class (to understand "NumericProperty" and "ReferenceListProperty", 
